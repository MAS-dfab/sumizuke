...
from ssd1306 import display_by_caracter, blink_screen, write_text_center
...
class MQTTClient(MQTT_base):
    ...
    async def wifi_connect(self, quick=False):
        ...
        if ESP8266:
            ...
            s.connect(self._ssid, self._wifi_pw)
            for _ in range(1500):  # Break out on fail or success. Check once per sec.
                display_by_caracter("connect..")
